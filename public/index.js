const PlusMinus = (props) => {
    ...
    return(
        <>
            <img src={`icons/${props.section}_plus.png`} id="plus" onClick={(e) => handle(e)}></img>
            <img src={`icons/${props.section}_minus.png`} id="minus" onClick={(e) => handle(e)}></img>
...
const App = () => {
    ...
    function handle(section) {
       const response = update(section.name, section.vaue)
            .then(res => {
                setData(res)
            })
    }
